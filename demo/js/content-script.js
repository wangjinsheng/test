...
function initCustomPanel()
{
	...
	<div class="btn-area-boss">
		<a href="javascript:sendMessageToContentScriptByPostMessage()">筛选牛人</a> &nbsp;&nbsp;&nbsp;<a href="javascript:requestWeixin()">取微信</a>&nbsp;&nbsp;&nbsp;<a href="javascript:requestResume()">取简历</a> <br>
		<a href="javascript:quickMessage()">快速消息</a> &nbsp;&nbsp;&nbsp; <a href="javascript:sendMessageToCandidate()">发消息</a> <br>
	</div>
	<div id="my_custom_log">
	</div>
	`;
